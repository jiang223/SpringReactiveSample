 ...
 * @since 5.0
 */
public class MQFilterChainProxy implements WebFilter {

	private final List<CustomMQFilterChain> filters;

	public MQFilterChainProxy(List<CustomMQFilterChain> filters) {
		this.filters = filters;
	}

	public MQFilterChainProxy(CustomMQFilterChain... filters) {
